...
function toOffer(catalogOffer: CatalogOffer, cardsById: Map<string, Card>, banksById: Map<string, Bank>): Offer {
  ...
  return {
    ...
    imageUrl: catalogOffer.imageUrl,
    ...
    cardNetworks: catalogOffer.cardNetworks,
    cardTypes: catalogOffer.cardTypes,
    cardTiers: catalogOffer.cardTiers,
    eligibilityNote: catalogOffer.eligibilityNote,
    // Rows imported before firstSeenAt existed fall back to their review date, as before.
    firstSeenAt: catalogOffer.firstSeenAt ?? catalogOffer.lastReviewedAt,
